<script lang="ts">
  ...
  import TrialCountdown from '$lib/components/notifications/TrialCountdown.svelte';
</script>

<svelte:head>
  <title>Dashboard | DoBbie</title>
  <meta name="description" content="Jouw persoonlijke dashboard voor verzuimbegeleiding." />
</svelte:head>
